function startTour() {
    this.document.getElementById("tour-popup").style.visibility = "hidden";
    document.getElementById("tour-1").style.boxShadow = "0 0 0 200vmax rgba(0, 0, 0, 0.8)";
...
function tourStep(step) {
    ...
    document.getElementById("tour-" + step).style.boxShadow = "0 0 0 200vmax rgba(0, 0, 0, 0.8)";
...
function skipTour() {
    document.getElementById("tour-popup").style.visibility = "hidden";
}
